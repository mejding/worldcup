...
MATCH_RESULTS_UPDATES_PATH = REFERENCE_DATA_DIR / "match_results_updates.csv"
...
FULL_BACKTEST_PREDICTIONS_PATH = PROCESSED_DATA_DIR / "full_backtest_predictions.csv"
FULL_BACKTEST_SUMMARY_PATH = PROCESSED_DATA_DIR / "full_backtest_summary.csv"
FULL_BACKTEST_BY_FOLD_PATH = PROCESSED_DATA_DIR / "full_backtest_by_fold.csv"
FULL_BACKTEST_BY_SEGMENT_PATH = PROCESSED_DATA_DIR / "full_backtest_by_segment.csv"
FULL_BACKTEST_CALIBRATION_PATH = PROCESSED_DATA_DIR / "full_backtest_calibration.csv"
FULL_BACKTEST_DRAW_CALIBRATION_PATH = PROCESSED_DATA_DIR / "full_backtest_draw_calibration.csv"
FULL_BACKTEST_MARKET_COMPARISON_PATH = PROCESSED_DATA_DIR / "full_backtest_market_comparison.csv"
FULL_BACKTEST_REPORT_PATH = REPORTS_DIR / "full_backtest_report.md"
BEST_PREDICTION_SOURCE_VALIDATION_PATH = PROCESSED_DATA_DIR / "best_prediction_source_validation.json"
